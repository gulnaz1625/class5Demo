...
**For the live class**: Each unit contains labs that you will need to complete and turn in to the instructor on Slack. You can find directions on how to submit homework to Slack [here](/docs/slack.md). 
...
| ----|-------- | --- |------ | 
| [Unit 00](/units/unit-0.md) | <ul> <li>installing Java</li> <li>installing intelliJ</li></ul>                                                          |[Pre-Course: Create a file tree](/practice/unit_0/exercise_1.md)                                    ||                               |
| [Unit 01](/units/unit-1.md) | <ul> <li>comments</li> <li>`print()`</li> <li>datatype: strings</li> <li>concatentate</li>                                      | [Lab 01: Hello World!](/labs/hello.md)                                                               | [Unit 01 ](/practice/unit_1/) |
